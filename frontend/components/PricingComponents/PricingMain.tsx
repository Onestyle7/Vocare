...
const pricingPlans = [
  {
    name: 'Osobiste',
    description: 'Idealne do znalezienia swojej ścieżki zawodowej.',
    price: 45,
    tokens: 500 as number | string,
    priceId: 'price_1ShEeILs2ndSVWb2ImxHTYQ3',
  ...
  {
    name: 'Rozwój',
    description: 'Najlepszy wybór do rozwoju Twojej kariery.',
    price: 29,
    tokens: 'Nielimitowany' as number | string,
    priceId: 'price_1ShEeGLs2ndSVWb29ieLO1TM',
  ...
  {
    name: 'Indywidualne',
    description: 'Twoja kariera prowadzona przez naszych ekspertów.',
    price: 99,
    tokens: '—' as number | string,
    priceId: 'price_1ShEeCLs2ndSVWb2MNv3RTBY',
            ...
            <div className="relative mt-6 mb-10 w-full px-4 md:px-6">
              ...
              <div className="font-grotesk grid items-end gap-8 md:grid-cols-3">
                ...
                <div className="relative z-30 flex h-full flex-col justify-between rounded-[24px] border bg-[linear-gradient(to_top_right,rgba(9,13,22,1)_20%,rgba(9,13,22,0.2)_100%)] p-6 backdrop-blur-md sm:h-[87%] dark:border-gray-500/40">
                  <div
                    aria-hidden
                    className="to-transpearent pointer-events-none absolute inset-0 rounded-[24px] bg-gradient-to-br from-white/25 via-white/10 dark:from-white/10 dark:via-white/5"
                  />
                ...
                <div className="relative z-30 flex h-full flex-col justify-between rounded-[24px] border bg-[linear-gradient(to_top_right,rgba(9,13,22,1)_20%,rgba(9,13,22,0.2)_100%)] p-6 backdrop-blur-md sm:h-[87%] dark:border-gray-500/40">
                  ...
                  <Button
                    ...
                    disabled={
                      !individualPlan || (isLoading && selectedPriceId === individualPlan.priceId)
                    }
                  >
        ...
        <AlertDialog open={individualDialogOpen} onOpenChange={setIndividualDialogOpen}>
          <AlertDialogContent className="font-grotesk max-w-md rounded-2xl">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                We&apos;ll reach out via <span className="font-bold text-[#818fff]">email</span> to
                the address associated with your payment once it comes through. <br />
                Do you want to continue to the secure checkout now?
              </AlertDialogDescription>
            </AlertDialogHeader>
