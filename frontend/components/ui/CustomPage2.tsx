...
const ContentPage2 = () => {
  return (
    <div className="flex h-screen w-screen flex-row bg-[#F3F3F3] max-md:flex-col">
      <div className="lgjustify-center font-poppins flex text-7xl text-[#101014] max-md:m-4 lg:h-screen lg:w-1/6 lg:items-center lg:text-[600px]">
        2
      </div>
      ...
      <div className="flex max-md:m-4 max-md:h-1/2 max-md:flex-col md:items-center md:justify-center lg:w-1/3 lg:items-center lg:justify-center">
        <TextAnimateLight
          animation="fadeIn"
          className="text-3xl sm:text-6xl lg:ml-6"
          by="line"
          as="p"
        >
